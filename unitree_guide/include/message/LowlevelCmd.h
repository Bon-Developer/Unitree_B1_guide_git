...
struct LowlevelCmd{
    ...
    void setSimStanceGain(int legID){
        ...
        motorCmd[legID*3+0].Kp = 500;
        motorCmd[legID*3+0].Kd = 300;
        motorCmd[legID*3+1].mode = 10;
        motorCmd[legID*3+1].Kp = 500;
        motorCmd[legID*3+1].Kd = 300;
        motorCmd[legID*3+2].mode = 10;
        motorCmd[legID*3+2].Kp = 500;
        motorCmd[legID*3+2].Kd = 300;
    }
